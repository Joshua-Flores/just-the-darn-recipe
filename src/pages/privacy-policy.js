...
const PolicySection = styled(Container)`
  margin-bottom: 48px;
  ...
  return (
    <Layout>
      <SEO
        ...
        description="Just The Darn Recipe Privacy Policy"
      />
      <PolicySection>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Just The Darn Recipe.
            </p>
            <p>
          ...
          <li>
            <p>
              <strong>Facebook Fan Page</strong> is a public profile named The
              Darn Recipe specifically created by the Company on the Facebook
              ...
              <a
                ...
                target="_blank"
              >
                https://facebook.com/thedarnrecipe
              </a>
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Just The Darn Recipe,
              accessible from{' '}
              <a
                href="https://justthedarnrecipe.com"
                rel="external nofollow noopener"
                target="_blank"
              >
        ...
        <ul>
          <li>By email: josh@justthedarnrecipe.com</li>
        </ul>
        <p>
